// Generated by Assets/Hananoki/Shared/Localize/ja-JP.csv
using HananokiEditor.Localize;
namespace Hananoki.Shared.Localize {
	public static class L {
		public static string Tr( string s ) {
			return EditorLocalize.Tr( EditorLocalize.GetPakage( "Shared" ), s );
		}
		public static string[] Tr( string[] ss ) {
			return EditorLocalize.Tr( EditorLocalize.GetPakage( "Shared" ), ss );
		}
	}
